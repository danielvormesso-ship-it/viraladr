...
const FOREIGN_LANG_PATTERNS = /\b(yapay[ıi]m|anla[dğ]|kadar[ıi]m|bercanda|serius|luôn|aussi|facile|apprend[sr]?|c'est|donc|alors|cette|avec|pour|dans|nous|vous|leur|quand|chez|sont|tout|tres|même|être|faire|comme|peut|j'ai|l'on|qu'il|qu'on|maniere|manière|nouvell|dembrasser|questa|quello|dieser|diese|terima ?kasih|salamat|salamat po|costrucion|construccion|encuentro|siempre|porque|cuando|donde|también|tambien|aunque|todavía|todavia|necesito|puedo|quiero|jefesito|enamorado|comear|sprawiaj|kobiety|szpach|legiobb|zagad|sprawia|piéces|essentielles|dressing|mignon|minimalist|setup|organisez|rangement|ikea hack|centavos|despensa|action diy|pièces)\b/i;
...
const Index = () => {
  ...
  const ALWAYS_EXCLUDE_KEYWORDS = [
    ...
    'pensamento', 'frases', 'frase do dia',
