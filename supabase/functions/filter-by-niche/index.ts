...
const NICHE_INSTRUCTIONS: Record<string, string> = {
  humor: "APROVAR SE o titulo contém: pegadinha, trote, susto, armadilha, zoeira, zueira, trolagem, trolou, trolei, humor, piada, engraçado, engraçada, meme, comedia, fail, queda, rir, risada, kkkk, kkkkk, viral com contexto de reacao, fyp com humor. REJEITAR APENAS SE CLARAMENTE é: dancinha coreografica sem humor, receita culinaria, tutorial tecnico, review de produto, cena de filme/serie comercial, promocao Netflix/Disney/Prime, videoclipe musical oficial, vlog de viagem, politica/eleicao. NA DUVIDA: APROVAR.",
